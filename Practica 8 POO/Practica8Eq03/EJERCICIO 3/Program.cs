...
class Program
{
    static void CalcularComisiones(float monto)
{
    foreach (Empleado empleado in listaEmpleados)
    {
        empleado.CalcularComisiones(monto);
    }
}
